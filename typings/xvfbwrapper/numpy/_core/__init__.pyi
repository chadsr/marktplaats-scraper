...
type _StringDTypeOrUnicodeArray = np.ndarray[_AnyShape, np.dtype[np.str_]] | _StringDTypeArray
...
@overload
def slice(
    a: U_co, start: i_co | None = ..., stop: i_co | None = ..., step: i_co | None = ..., /
) -> NDArray[np.str_]: ...
@overload
def slice(
    a: S_co, start: i_co | None = ..., stop: i_co | None = ..., step: i_co | None = ..., /
) -> NDArray[np.bytes_]: ...
@overload
def slice(
    a: _StringDTypeSupportsArray,
...
@overload
def slice(
    a: T_co, start: i_co | None = ..., stop: i_co | None = ..., step: i_co | None = ..., /
