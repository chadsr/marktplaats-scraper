...
class RandomState:
    ...
    @overload
    def randint(
        self, low: int, high: int | None = ..., size: None = ..., dtype: type[bool] = ...
    ) -> bool: ...
    @overload
    def randint(
        self, low: int, high: int | None = ..., size: None = ..., dtype: type[np.bool] = ...
    ) -> np.bool: ...
    @overload
    def randint(
    ...
    @overload
    def choice(
        self, a: int, size: None = ..., replace: bool = ..., p: _ArrayLikeFloat_co | None = ...
    ) -> int: ...
    @overload
    def choice(
        self,
