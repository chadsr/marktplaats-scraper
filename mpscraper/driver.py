...
class MPDriver(WebDriver):
    ...
    def __get_mp_err_text(soup: Soup) -> str | None:
        ...
        err_msg_name = "p"
        err_msg_attrs: dict[str, str] = {"class": "mp-Alert--error"}
        ...
        err_pages_name = "div"
        err_pages_attrs: dict[str, str] = {"class": "hz-ErrorPage-message"}
        err_pages = soup.find_all(name=err_pages_name, class_="hz-ErrorPage-message")
        if len(err_pages) > 0:
            ...
            err_div_name = "div"
            err_div_attrs: dict[str, str] = {"class": "u-textStyleTitle3"}
            err_div = err_page.find(name=err_div_name, class_="u-textStyleTitle3")
